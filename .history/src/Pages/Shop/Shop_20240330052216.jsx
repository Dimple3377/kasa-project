...
const Shop = ({ match }) => {
  ...
  return (
    <div className="shop-page">
      <Banner title={propertyDetails.title} backgroundUrl={/* URL de l'image de l'en-tête */} />
      ...
      <div className="property-details">
        ...
        <div className="property-tags">
          {propertyDetails.tags.map(tag => <span className="tag">{tag}</span>)}
        </div>
        ...
        <div className="property-equipments">
          <h3>Équipements</h3>
          <ul>
            {propertyDetails.equipments.map(equipment => <li>{equipment}</li>)}
          </ul>
        </div>
      </div>
